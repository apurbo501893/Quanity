  ...
  return (
    <div className="flex py-6 sm:py-10">
      <Link
        ...
        className="h-24 w-24 sm:h-48 sm:w-48 border border-skyColor/30 hover:border-skyColorcoverflow-hidden flex items-center justify-center rounded-md"
      >
        <Image
      ...
      <div className="ml-4 sm:ml-6 flex flex-1 flex-col justify-between">
        <div className="relative pr-9 sm:grid sm:grid-cols-4 sm:gap-x-6 sm:pr-6">
